export default function Info() {
  return (
    <div className="w-full h-full text-white flex items-center justify-center py-22 xl:py-35 xl:px-10">
      <div className="grid md:grid-cols-3 md:grid-rows-3 gap-4 w-full h-full p-4">
        ...
        <div className="md:row-span-2 md:col-start-3 bg-white rounded-2xl p-3 shadow-md">2</div>
